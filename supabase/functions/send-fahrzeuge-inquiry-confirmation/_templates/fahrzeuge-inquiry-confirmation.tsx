...
interface FahrzeugeInquiryConfirmationEmailProps {
  branding: any;
  inquiry: any;
  vehicles: any[];
...
export const FahrzeugeInquiryConfirmationEmail = ({
  branding,
  inquiry,
  vehicles,
  logoBase64,
}: FahrzeugeInquiryConfirmationEmailProps) => {
            ...
            <table style={table}>
              <thead>
                <tr>
                  ...
                  <th style={th}>Laufleistung</th>
                  <th style={thRight}>Preis (inkl. MwSt.)</th>
                </tr>
              </thead>
              <tbody>
                {vehicles.map((vehicle: any, i: number) => (
                  <tr key={i}>
                    ...
                    <td style={td}>{formatKilometers(vehicle.kilometers || 0)}</td>
                    <td style={tdRight}>
              ...
              <tfoot>
                <tr>
                  <td colSpan={3} style={tfootLabel}>Gesamtsumme:</td>
                  <td style={tfootTotal}>
...
export default FahrzeugeInquiryConfirmationEmail

// Professional, modern styles for vehicle sales
const main = {
