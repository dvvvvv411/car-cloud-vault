...
const Index = () => {
  ...
  return <div className="min-h-screen bg-background relative">
      <div className="max-w-[1400px] mx-auto px-8 py-12">
        ...
        <div className="mb-12 animate-fade-in">
          <div className="flex items-start gap-6 mb-6">
            <img src={kbsLogo} alt="KBS Kanzlei Logo" className="h-24 w-auto" />
            ...
            <div className="flex-1 relative min-h-[8rem]">
              ...
              <div className="mb-2">
                <h1 className="text-5xl font-light tracking-tight" style={{
          ...
          animationDelay: "0.1s"
              ...
              <div className="glassmorphism rounded-2xl p-4 shadow-sm">
                ...
                color: "hsl(var(--text-tertiary))"
                  ...
                  <Input placeholder="Suche nach Marke, Modell oder Fahrgestell-Nr..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="pl-12 h-12 text-base border-0 bg-transparent focus-visible:ring-1 focus-visible:ring-primary" />
                </div>
              </div>
            </div>
      ...
      {showInquiryForm && selectedVehicles.length > 0 && <div className="fixed bottom-[160px] left-0 right-0 z-40 px-8">
