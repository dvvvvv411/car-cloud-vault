...
export function getBrandingColor(firmName: string | null | undefined): string {
  if (!firmName) {
    return "bg-gray-100 text-gray-800 border-gray-300";
  }

  // Deterministische Farbgenerierung für Kanzleien
  const colors = [
    "bg-blue-100 text-blue-800 border-blue-300",
    "bg-green-100 text-green-800 border-green-300",
    "bg-orange-100 text-orange-800 border-orange-300",
  ...
  // Hash-basierte Farbauswahl (gleicher Name = gleiche Farbe)
  let hash = 0;
